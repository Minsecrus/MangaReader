        ...
        for lib_path in libiomp_candidates:
            if os.path.exists(lib_path):
                try:
                    ...
                    print(f"[Backend Service] [INFO] Successfully pre-loaded: {lib_path}")
                    break
                except Exception as e:
                    print(f"[Backend Service] [WARNING] Failed to pre-load {lib_path}: {e}")
...
def patch_libraries():
    ...
    try:
        ...
        print("[Backend Service] [INFO] Successfully patched transformers.utils.import_utils.check_torch_load_is_safe")
    except ImportError:
        print("[Backend Service] [WARNING] Could not import transformers.utils.import_utils to patch")
    except Exception as e:
